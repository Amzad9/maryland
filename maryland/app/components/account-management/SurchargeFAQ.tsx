...
export default function SurchargeFAQAccordion() {
  ...
  const faqs = [
    ...
    {
      question: "What are most states' surcharge disclosure requirements?",
      answer: "Businesses must: 1) Register with card networks 30 days in advance, 2) Display specific signage at entry and POS, 3) Show surcharge amounts on receipts separately, and 4) Limit fees to actual processing costs. Dual pricing requires none of this.",
      highlight: false,
