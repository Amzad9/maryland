import { 
  ...
  export default function WhyChooseUs() {
    const reasons = [
      {
        title: "Local Payment Processing Company",
        description: "Maryland-based team providing professional installation, training, and same-day local support.",
      ...
      },
      {
        ...
        description: "Transparent pricing with competitive rates and no hidden fees for Maryland businesses.",
      ...
      },
      {
        ...
        description: "Deep understanding of Maryland business requirements and local regulations.",
      ...
      },
      {
        ...
        description: "Local team provides same-day support and equipment replacement throughout MD, PA, WV.",
          ...
          {/* <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="relative overflow-hidden rounded-xl">
              ...
              <div className="relative text-center p-6">
                ...
                <div className="text-gray-700 font-medium">Local Support</div>
              </div>
            </div>
